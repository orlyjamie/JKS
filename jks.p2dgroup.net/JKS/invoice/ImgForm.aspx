<%@ Page Language="c#" CodeBehind="ImgForm.aspx.cs" AutoEventWireup="false" Inherits="CBSolutions.ETH.Web.ETC.invoice.ImgForm" %>
    ...
    <script language="javascript">
        ...
        function showSelection() {
            ...
            if (window.parent.refHeight > 0 && window.parent.refWidth > 0 && window.parent.selectTop >= 0 && window.parent.selectLeft >= 0 && window.parent.selectHeight > 0 && window.parent.selectWidth > 0) {
                ...
                obj.style.top = Math.round(window.parent.selectTop * Form1.DocImg.height / window.parent.refHeight - jiggle_y * 2); //JCB  3 was +7
                obj.style.left = Math.round(left - jiggle_x); // was -6
                obj.style.height = Math.round(height + jiggle_y * 5.3); //JCB  3
                obj.style.width = Math.round(width + jiggle_x * 2); //was +16

                var bottom = window.parent.selectBottom; //JCB  22
                // Idea was to reduce cumulative error on zooming, using bottom, but I think now acceptable //JCB  22
        ...
        function scaleImage() {
            var scale = window.parent.frames("ImgToolbar").Form1.lbScale.options[window.parent.frames("ImgToolbar").Form1.lbScale.selectedIndex].value
        ...
        function onMouseDown() {
            ...
            window.parent.frames("ImgToolbar").imgMouseClick(x, y);
        }
...
<body bgcolor="buttonface" onload="doReset();" ms_positioning="GridLayout">
    ...
    <img onmousedown="onMouseDown();" id="DocImg" style="z-index: 101; left: 0px; position: absolute;
        top: 0px" alt="" onload="imgLoad();" galleryimg="false">
