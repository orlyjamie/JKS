...
{
    /// <summary>
    /// Summary description for BuyerInvoiceHistory.
    /// </summary>
    public class BuyerInvoiceHistory : CBSolutions.ETH.Web.ETC.VSPage
    {
        ...
        private void LoadData(int iCompanyID)
        {
            ...
            sqlDA = new SqlDataAdapter("stpGetPurchaseInvoiceHistory_NL", sqlConn);
            ...
            sqlDA.TableMappings.Add("InvoiceDetails1", "InvoiceLog");
            ...
            ds.Relations.Add("InvoiceHeader_InvoiceHistory", ds.Tables["InvoiceHeader"].Columns["InvoiceID"], ds.Tables["InvoiceLog"].Columns["InvoiceID"]);
        ...
        protected string GetURL(object oInvoiceID)
        {
            ...
            string strURL = "";
            strURL = "javascript:window.open('InvoicePassToUserNL.aspx?InvoiceID=" + strInvoiceID + "','a','width=975,height=450');";
            return (strURL);
        }
        #endregion
        ...
        private void LoadDataAtLogin(int iCompanyID, int iPassedToUserID)
        {
            ...
            sqlConn = new SqlConnection(CBSAppUtils.PrimaryConnectionString);
            sqlDA = new SqlDataAdapter("stpGetInvoiceDetailsAtLogin1NL", sqlConn);
            sqlDA.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        private void LoadDataSearch(int iCompanyID)
        {
            ...
            {
                sqlConn = new SqlConnection(CBSAppUtils.PrimaryConnectionString);
                sqlDA = new SqlDataAdapter("stpGetPurchaseInvoiceHistorySearch_NL", sqlConn);
                sqlDA.SelectCommand.CommandType = CommandType.StoredProcedure;
                sqlDA.SelectCommand.Parameters.Add("@CompanyID", iCompanyID);
                sqlDA.SelectCommand.Parameters.Add("@SupplierCompanyID", ddlSupplier.SelectedValue.Trim());
                sqlDA.SelectCommand.Parameters.Add("@ActionStatusID", ddlActionStatus.SelectedValue.Trim());
