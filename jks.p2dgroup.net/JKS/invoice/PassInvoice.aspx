<%@ Page Language="c#" CodeBehind="PassInvoice.aspx.cs" AutoEventWireup="false" Inherits="CBSolutions.ETH.Web.ETC.Invoice.PassInvoice" %>
...
<html>
<head>
    <title>P2D NetBuyer - Pass/Approve Purchase Invoice</title>
                ...
                <table id="Table1" width="100%">
                    <tr>
                        <td class="PageHeader" width="100%">
                            Pass Purchase Invoice &nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td class="NormalBody">
                            Select Company Name To View Invoice&nbsp;
                            <asp:DropDownList ID="ddlCompany" TabIndex="4" runat="server" CssClass="MyInput"
                                Width="200px" AutoPostBack="True" DataValueField="CompanyID" DataTextField="CompanyName">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="NormalBody" style="height: 1px">
                            Supplier Name&nbsp;
                            <asp:DropDownList ID="ddlSupplier" TabIndex="4" runat="server" CssClass="MyInput"
                                Width="200px" DataValueField="CompanyID" DataTextField="CompanyName" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="NormalBody">
                            Action Status&nbsp; &nbsp;
                            <asp:DropDownList ID="ddlActionStatus" TabIndex="4" runat="server" CssClass="MyInput"
                                Width="200px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="NormalBody">
                            Doc Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:DropDownList ID="ddlDocStatus" TabIndex="4" runat="server" CssClass="MyInput"
                                Width="200px" DataValueField="StatusID" DataTextField="Status">
                            </asp:DropDownList>
                            &nbsp;
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="NormalBody" valign="top" style="height: 35px">
                            Doc Date Ranges &nbsp;&nbsp;From
                            <asp:DropDownList ID="ddlYear" runat="server" CssClass="MyInput" AutoPostBack="True"
                                Width="65px">
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlMonth" runat="server" CssClass="MyInput" AutoPostBack="True"
                                Width="65px">
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlday" runat="server" CssClass="MyInput" AutoPostBack="True"
                                Width="65px">
                            </asp:DropDownList>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            TO
                            <asp:DropDownList ID="ddlYear1" runat="server" CssClass="MyInput" AutoPostBack="True"
                                Width="65px">
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlMonth1" runat="server" CssClass="MyInput" AutoPostBack="True"
                                Width="65px">
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlday1" runat="server" CssClass="MyInput" AutoPostBack="True"
                                Width="65px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="NormalBody">
                            Net Total Ranges &nbsp;
                            <asp:TextBox ID="textRange1" runat="server" Width="100px"></asp:TextBox>-<asp:TextBox
                                ID="textRange2" runat="server" Width="100px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="NormalBody">
                            ...
                            <asp:DataGrid ID="grdInvCur" runat="server" Width="100%" AllowSorting="True" Font-Size="10pt"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Action">
                                        <ItemTemplate>
                                            <a href='#' onclick="<%# GetURL(DataBinder.Eval(Container.DataItem,"InvoiceID"))%>">
                                                <b>Action </b></a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:BoundColumn DataField="ActionDate" HeaderText="Date Last Actioned" DataFormatString="{0:dd-MM-yyyy}">
                                    </asp:BoundColumn>
