<%@ Page Language="c#" CodeFile="InvoiceEdit.aspx.cs" AutoEventWireup="false" Inherits="JKS.InvoiceEdit" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function AddConfirm() {
            window.open('InvoiceDetailAdd.aspx?InvoiceID=<%=invoiceID%>', 'hhh', 'left=100,top=50,width=840,height=600,resizable=1,scrollbars=1');
        }
        ...
        function CheckComment() {
            for (var j = 0; j < document.Form1.elements.length; j++) {
                if (document.Form1.elements[j].type == "text") {
                    var strTextBox = document.Form1.elements[j].id;

                    var strTextBoxVal = document.Form1.elements[j].value;
                    if (strTextBoxVal == '' || (strTextBoxVal != '' && !IsNumeric(strTextBoxVal))) {
                        if (strTextBox.indexOf("txtPrice") != -1) {
                            alert('Check Price in Line items and click Calculate');
                            return false;
                        }
                        if (strTextBox.indexOf("txtQuantity") != -1) {
                            alert('Check Quantity in Line items and click Calculate');
                            return false;
                        }
                        if (strTextBox.indexOf("txtNetValue") != -1) {
                            alert('Please enter line details and press Calculate');
                            return false;
                        }
                        /* --- BLocked by Mrinal on 24th Feb 2015----

                        if (strTextBox.indexOf("txtVAT") != -1) {
                        alert('Check VAT Amount in Line items');
                        return false;
                        }
                        
                        if (strTextBox.indexOf("txtGrossValue") != -1) {
                        alert('Please press Calculate to populate line level VAT and Gross before saving');
                        return false;
                        }
                        */
                ...
                <div class="login_bg">
                    <div class="current_comp">
                        <div class="form-horizontal form_section">
                            <div class="row">
                                <asp:Label ID="lblConfirmation" runat="server" CssClass="PageHeader">Edit Invoice Data</asp:Label>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="col-md-12">
                                        <div class="form-group form-group2">
                                            <asp:Label ID="lblRefernce" runat="server" CssClass="col-lg-5 control-label label_text"
                                                Style="display: none;">Invoice No. : </asp:Label>
                                        </div>
                                        <div class="form-group form-group2">
                                        ...
                                        <div class="form-group form-group2">
                                            <label for="inputEmail" class="col-xs-12 col-sm-5 control-label label_text GridCaption">
                                                Supplier</label>
                                            <div class="col-xs-12 col-sm-7">
                                                <asp:DropDownList ID="ddlSupplier" runat="server" CssClass="form-control inpit_select"
                                                    DataValueField="CompanyID" DataTextField="CompanyName" AutoPostBack="True" Visible="false">
                                                </asp:DropDownList>
                                                <asp:TextBox ID="txtSupplier" runat="server" CssClass="form-control inpit_select" />
                                        ...
                                        <div class="form-group form-group2" style="display: none">
                                            <label for="inputEmail" class="col-xs-12 col-sm-5 control-label label_text GridCaption">
                                                Currency</label>
                                            <div class="col-xs-12 col-sm-7">
                                                <asp:Label ID="lblCurrency" runat="server" CssClass="form-control inpit_select"></asp:Label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group form-group2" style="display: none">
                                            <label for="inputEmail" class="col-xs-12 col-sm-5 control-label label_text GridCaption">
                                                Delivery Date</label>
                                            <div class="col-xs-12 col-sm-7">
                                                <asp:Label ID="lblDespatchDate" runat="server" CssClass="col-lg-12 control-label label_text"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="PO No." ItemStyle-Width="123px">
                                                    <ItemTemplate>
                                                        ...
                                                        <%--classPONumber Added by Mainak 2018-10-02--%>
                                                    </ItemTemplate>
                                                ...
                                                <%--<asp:BoundField Visible="false" DataField="InvoiceDetailID" HeaderText="InvoiceDetailID">
                                                    <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                </asp:BoundField>--%>
                                            </Columns>
                                        </asp:GridView>
                                            ...
                                            <tr>
                                                <td width="60%">
                                                    <div class="col-lg-12" style="margin-top: 15px;">
                                                        <div class="form-group form-group2">
                                                            <label for="inputEmail" class="col-xs-12 col-sm-4 control-label label_text">
                                                    ...
                                                    <table width="300" style="margin-right: 10px;">
                                                        <tr>
                                                            ...
                                                            <td style="height: 16px;" align="right">
                                                                <asp:TextBox ID="txtNetTotal" runat="server" Style="width: 67px" CssClass="form-control inpit_select"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="GridCaption" style="width: 170px; height: 15px" align="right">
                                                                VAT
                                                                <asp:HyperLink ID="Hyperlink2" runat="server" NavigateUrl="javascript:ShowMessage()"
                                                                    ImageUrl="../../images/i.jpg"></asp:HyperLink>
                                                            </td>
                                                            <td style="height: 15px;" align="right">
                                                                <asp:TextBox ID="txtVATAmtNew" runat="server" Style="width: 67px" CssClass="form-control inpit_select"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                <asp:TextBox ID="txtTotAmt" runat="server" Style="width: 67px" CssClass="form-control inpit_select"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="trInputSterlingEquiAmt" runat="server">
                                                            ...
                                                            <td align="right">
                                                                <asp:TextBox ID="txtSterlingEquivalent" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-1 form-group2">
                                <span id="sp_Back"><a onclick="javascript:history.back();" href="#" cssclass="sub_down btn-primary btn-group-justified center_alin">
                                    Back </a></span>
                            </div>
                            ...
                            <div class="col-md-2 form-group2">
                                <asp:Button ID="btnDelete" runat="server" CssClass="sub_down btn-primary btn-group-justified center_alin"
                                    BorderStyle="None" Text="Delete Lines" CommandName="BtnDelete"></asp:Button>
                            </div>
                            <div class="col-md-2 form-group2">
        ...
        $(function () {
            ...
            $("#txtSupplier").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        url: "InvoiceEdit.aspx/GetSupplier",
            ...
            $(this).autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "InvoiceEdit.aspx/ListPONumber",
