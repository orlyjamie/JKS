<%@ Page Language="c#" CodeBehind="ecVatNL_CN.aspx.cs" AutoEventWireup="false" Inherits="CBSolutions.ETH.Web.ETC.CreditNotes.ecVatNL_CN" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>ecVatNL_CN</title>
        ...
        <tr>
            <td valign="top">
                ...
                <table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:DataGrid ID="grdInvoiceDetails" runat="server" Width="960px" Height="88px" BorderColor="#999999"
