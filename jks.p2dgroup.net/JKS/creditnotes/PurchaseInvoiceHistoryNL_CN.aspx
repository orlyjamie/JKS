<%@ Page Language="c#" CodeBehind="PurchaseInvoiceHistoryNL_CN.aspx.cs" AutoEventWireup="false"
    Inherits="CBSolutions.ETH.Web.ETC.CreditNotes.PurchaseInvoiceHistoryNL_CN" %>
...
<html>
<head>
    <title>PurchaseInvoiceHistoryNL_CN</title>
                        ...
                        <td>
                            <asp:DataGrid ID="grdInvCur" runat="server" Width="100%" AllowSorting="True" Font-Size="10pt"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="CreditInvoiceNo" HeaderText="Invoice No."></asp:BoundColumn>
