<%@ Page Language="c#" CodeBehind="PassInvoice_NL_CN.aspx.cs" AutoEventWireup="false"
    Inherits="CBSolutions.ETH.Web.ETC.CreditNotes.PassInvoice_NL_CN" %>
...
<html>
<head>
    <title>PassInvoice_NL_CN -P2D Network</title>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <table id="Table1" width="100%">
                    ...
                    <tr>
                        <td class="NormalBody">
                            Select Company Name To View Credit Note&nbsp;
                            ...
                            <asp:DataGrid ID="grdInvCur" runat="server" Width="100%" AllowSorting="True" Font-Size="10pt"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Select">
                                        <ItemTemplate>
                                            <a href='InvoiceConfirmationNL_CN.aspx?InvoiceID=<%#DataBinder.Eval(Container.DataItem,"CreditNoteID")%>'>
                                    ...
                                    <asp:TemplateColumn HeaderText="Pass To History" Visible="False">
                                        <ItemTemplate>
                                            <a href='#' onclick="<%#GetLogURL(DataBinder.Eval(Container.DataItem,"CreditNoteID"))%>">
                                                <b>Credit Note Log History </b></a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Action">
                                        <ItemTemplate>
                                            <a href='#' onclick="<%#GetURL(DataBinder.Eval(Container.DataItem,"CreditNoteID"))%>">
                                                <b>Action </b></a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Status History">
                                        <ItemTemplate>
                                            <a href='#' onclick="<%#GetStatusURL(DataBinder.Eval(Container.DataItem,"CreditNoteID"))%>">
                                    ...
                                    <asp:BoundColumn Visible="False" DataField="InvoiceDate" SortExpression="InvoiceDate"
                                        HeaderText="Credit Note Date" DataFormatString="{0:dd-MM-yyyy}"></asp:BoundColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="History" Visible="False">
                                        <ItemTemplate>
                                            <a href='#' onclick="<%#GetCommentURL(DataBinder.Eval(Container.DataItem,"CreditNoteID"))%>">
                                                <b>Show History </b></a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                </Columns>
