...
{
    /// <summary>
    /// Summary description for PurchaseInvoiceHistoryNL_CN.
    /// </summary>
    public class PurchaseInvoiceHistoryNL_CN : CBSolutions.ETH.Web.ETC.VSPage
    {
        #region WebControls
        ...
        private void CreateTable()
        {
            ...
            objDataTable.Columns.Add("CreditInvoiceNo");
        ...
        protected string GetURL(object oInvoiceID)
        {
            ...
            string strURL = "";
            strURL = "javascript:window.open('InvoicePassToUserNL_CN.aspx?InvoiceID=" + strInvoiceID + "','HIST','width=975,height=450');";
        ...
        protected string GetCommentURL(object oInvoiceID)
        {
            string strInvoiceID = Convert.ToString(oInvoiceID);
            string strURL = "";
            strURL = "javascript:window.open('show_comments_CN.aspx?InvoiceID=" + strInvoiceID + "','SC','width=675,height=450');";
        ...
        protected string GetLogURL(object oInvoiceID)
        {
            string strInvoiceID = Convert.ToString(oInvoiceID);
            string strURL = "";
            strURL = "javascript:window.open('InvoiceLogHistory_CN.aspx?InvoiceID=" + strInvoiceID + "','ILH','width=1000,height=650,scrollbars=yes');";
