...
using CBSolutions.ETH.Web.UniversalMusic.CreditNotes;

namespace JKS
{
    /// <summary>
    /// Summary description for InvoiceEdit_CN.
    /// </summary>
    /// 
    [ScriptService]
    public partial class InvoiceEdit_CN : SVSPage //was CBSolutions.ETH.Web.ETC.VSPage
    {
        ...
        JKS.Invoice objInvoiceSupp = new JKS.Invoice();
        //CBSolutions.ETH.Web.ETC.Invoice.Invoice objInvoiceSupp = new CBSolutions.ETH.Web.ETC.Invoice.Invoice();
        Invoice_CN objInvoice = new Invoice_CN();
        public int vRFlag = 0;//Added by Mainak 2018-10-01
        JKS.Invoice_NL_CN objInvoiceNEW = new JKS.Invoice_NL_CN();
        ...
        protected string strforDelete = "";
        int currentYear = 0;

        DateTime InvDate;
        ////protected System.Web.UI.WebControls.TextBox txtComments;
        DateTime TaxDate;
        protected System.Web.UI.HtmlControls.HtmlAnchor qq;
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                GetCompanyListForPurchaseInvoiceLog(Convert.ToInt32(Session["CompanyID"])); //Sourayan24-11-2008
                PopulateData(invoiceID);

                if (!string.IsNullOrEmpty(Session["txtNetTotal"] as string) && !string.IsNullOrEmpty(Session["txtTotAmt"] as string) && !string.IsNullOrEmpty(Session["txtVATAmtNew"] as string))
                {
                    // txtNetTotal.Text = Convert.ToString(Session["txtNetTotal"]);//Commeneted by Rimi on 17thJuly2015
                    // txtTotAmt.Text = Convert.ToString(Session["txtTotAmt"]);//Commeneted by Rimi on 17thJuly2015
                    // txtVATAmtNew.Text = Convert.ToString(Session["txtVATAmtNew"]);//Commeneted by Rimi on 17thJuly2015
                }
        ...
        {
            //Added by Mrinal on 21st February 2014
        ...
        public void PopulateHeaderFirstTime()
        {
            ...
            RecordSet rsCurrency = Invoice_CN.GetCurrencyTypesList();
            ...
            try
            {
                Invoice_NL_CN oInvoice = new Invoice_NL_CN();
            ...
            /*
                        ...
                        ddlSupplier.SelectedValue=rsInvoiceHead["SupplierCompanyID"].ToString();	//Sourayan24-11-2008
            ...
            {
                //ddlSupplier.DataSource = objInvoiceSupp.GetSuppliersList(Convert.ToInt32(ddlCompany.SelectedValue));
                //ddlSupplier.DataBind();
                //ddlSupplier.Items.Insert(0, new ListItem("Select Supplier", "0"));
            }

            ViewState["BuyerCID"] = rsInvoiceHead["BuyerCompanyID"].ToString(); //Added by Mainak 2018-10-01
            ...
            if (rsInvoiceHead["StatusId"] != DBNull.Value)
                lblStatus.Text = Invoice_CN.GetStatus((int)rsInvoiceHead["StatusId"]);  //160505 SURAJIT
            else
        ...
        public void PopulateData()
        {
            ...
            DT.Columns.Add("CreditNoteDetailID", typeof(int));
            DT.Columns.Add("CreditNoteID", typeof(int));//Modified by Mainak 2018-10-26
            ...
            //DT.Columns.Add("InvoiceDetailID");//Modified by Mainak 2018-10-26
            //DT.Rows.Add("", "", "", "", "", "", "", "NOT FOUND", "0", "", "", "", "", "", "", "", "", "", "", "","", "", "", "", "","", "", "", "", "","", "", "", "", "","", "", "", "", "","", "", "", "", "","", "", "", "", "");
            #endregion

            RecordSet rs2 = null;
            //If XML file exists load XML into recordset
            if (System.IO.File.Exists(Session["XMLInvoiceDetailFile_CN"].ToString()) && Convert.ToInt32(Session["EditInvID"]) == Convert.ToInt32(Request.QueryString["InvoiceID"]))
            {

                DataSet ds2 = new DataSet();
                ds2.ReadXmlSchema(Session["XSDInvoiceDetailFile_CN"].ToString());
                ds2.ReadXml(Session["XMLInvoiceDetailFile_CN"].ToString());
            ...
            else
            {
                ...
                ds.WriteXmlSchema(Session["XSDInvoiceDetailFile_CN"].ToString());
                ds.WriteXml(Session["XMLInvoiceDetailFile_CN"].ToString());
                ...
                string sXMLPath = Session["XMLInvoiceDetailFile_CN"].ToString();
        ...
        private void GetCompanyListForPurchaseInvoiceLog(int iCompanyID)
        {
            ...
            ddlCompany.DataBind();
            ddlSupplier.DataSource = objInvoiceSupp.GetSuppliersListNEW(Convert.ToInt32(Session["CompanyID"]));
            ddlSupplier.DataBind();
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (ddlVATRate != null)
                {
                    if (e.Row.DataItem != null)
                    {
                        ...
                        // Added by Mrinal on 28th March 2015
                        ddlVATRate.Items.Insert(0, new ListItem("Select", "Select"));
                    }
                }
                // Blocked by Mrinal on 25th March 2015
                //((System.Web.UI.WebControls.DropDownList) e.Row.FindControl("dpVATRate")).SelectedValue="15.00";

                //Added by kuntalkarar on 5thJune2017
        ...
        private void btnSave_Click(object sender, System.EventArgs e)
        {
            ...
            //			strInvoiceDate=txtInvDate.Text;
            ...
            {
                //				strInvoiceDate    	=	cboYearInvoiceDate.SelectedValue + "/" + cboMonthInvoiceDate.SelectedValue + "/" + cboDayInvoiceDate.SelectedValue ;
            ...
            string getvendorClass = "SELECT  TradingRelation.New_VendorClass FROM TradingRelation INNER JOIN CreditNote ON TradingRelation.BuyerCompanyID = CreditNote.BuyerCompanyID AND TradingRelation.SupplierCompanyID = CreditNote.SupplierCompanyID where CreditNote.CreditNoteID=" + InvID + " and CreditNote.BuyerCompanyID=" + Convert.ToInt32(ViewState["BuyerCID"].ToString()) + " and CreditNote.SupplierCompanyID=" + SID + "";
            ...
            DataTable dtLVt = objInvoiceNEW.GetLineVatByBuyerCompanyId(Convert.ToInt32(ViewState["BuyerCID"]));
            DataTable dtTXRt = objInvoiceNEW.GetTaxRateByBuyerCompanyId(Convert.ToInt32(ViewState["BuyerCID"]));
            ...
            if (vRInfiFlag == 0)
            {
                if (dtNewVc.Rows.Count > 0)
                {
                    if (dtNewVc.Rows[0]["New_VendorClass"].ToString() == "PO")
                    {
                        ...
                        {
                            #region btnSave
                            iRetValue = objInvoiceNEW.SaveInvoiceDatatoDataBase(Convert.ToInt32(Session["UserID"]), InvID, strInvoiceNo, strSupplierCompanyID, strBuyerCompanyID,
                            ...
                            if (iRetValue > 0)
                            {
                                Session["IsFromEDITDATAPage"] = "yes";
                                if (Request.QueryString["IsParentReload"] != null && Convert.ToInt32(Request.QueryString["IsParentReload"].ToString()) == 1)
                                {
                                    ...
                                    //Session["BuyerCompanyIdFromEditdata_CN"] = strBuyerCompanyID;
                                    //Session["SupplierCompanyIDFromEditdata_CN"] =  strSupplierCompanyID;
                                    // Session["IsFromEDITDATAPage"] = "yes";
                                ...
                                {
                                    //Added by kuntalkarar on 9thMArch2016
                                    //Session["BuyerCompanyIdFromEditdata_CN"] = "";
                                    //Session["SupplierCompanyIDFromEditdata_CN"] = "";
                                    ...
                                    if (Request.QueryString["AllowEdit"].ToString() == "Current")
                                    {
                                        ...
                                        dt = objInvoiceNEW.GetCreditnoteDetails(InvID);
                                        ...
                                        dstempInvoiceDetail.ReadXmlSchema(Session["XSDInvoiceDetailFile_CN"].ToString());
                                        dstempInvoiceDetail.ReadXml(Session["XMLInvoiceDetailFile_CN"].ToString());
                                        int lastrowIndext = dstempInvoiceDetail.Tables[0].Rows.Count - 1;

                                        if (lastrowIndext > 0)
                                        {
                                            dstempInvoiceDetail.Tables[0].Rows[lastrowIndext]["CreditNoteDetailID"] = dt.Rows[lastrowIndext]["CreditNoteDetailID"].ToString();
                                        }
                                        dstempInvoiceDetail.WriteXmlSchema(Session["XSDInvoiceDetailFile_CN"].ToString());
                                        dstempInvoiceDetail.WriteXml(Session["XMLInvoiceDetailFile_CN"].ToString());*/
                                        //-------------------------------------------------------------------------


                                        /*Added by kuntalkarar on 25thJuly2017*/
                                        DataSet dstempInvoiceDetail2 = new DataSet();
                                        dstempInvoiceDetail2.ReadXmlSchema(Session["XSDInvoiceDetailFile_CN"].ToString());
                                        dstempInvoiceDetail2.Tables[0].Merge(dt);
                                        dstempInvoiceDetail2.WriteXml(Session["XMLInvoiceDetailFile_CN"].ToString());
                                        /*Added by kuntalkarar on 25thJuly2017*/
            ...
            string strInvoiceDate, string strTaxPointDate, string strCurrency)
        {
            if (System.IO.File.Exists(Session["XMLInvoiceHeadFile_CN"].ToString()))
            {
                ...
                ds1.ReadXmlSchema(Session["XSDInvoiceHeadFile_CN"].ToString());
                ds1.ReadXml(Session["XMLInvoiceHeadFile_CN"].ToString());
        ...
        public string UpdateInvoiceDetailinXML()
        {
            ...
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                ...
                {
                    //lblError.Text="Check Net Value in Line items";
            ...
            //Converting DATATABLE TO DATASET, THEN TO CBS RECORDSET
            rs = new RecordSet(dt.DataSet);
            //save the invoice detail recordset in XML format
            ...
            //Converting Edited XML file to STRING Variable(Start)
            StringBuilder oBuilder = new StringBuilder();
            StringWriter oStringWriter = new StringWriter(oBuilder);
            XmlTextReader oXmlReader = new XmlTextReader(Session["XMLInvoiceDetailFile_CN"].ToString());
            XmlTextWriter oXmlWriter = new XmlTextWriter(oStringWriter);
            while (oXmlReader.Read())
            {
                oXmlWriter.WriteNode(oXmlReader, true);
            ...
            //Converting Edited XML file to STRING Variable(End)
        ...
        private void btnDelete_Click(object sender, System.EventArgs e)
        {
            for (int j = grdInvoiceDetails.Rows.Count - 1; j >= 0; j--)
            {
                ...
                {
                    /*Added by kuntalkarar on 5thJune2017*/
                    lblstrDelete.Text = lblstrDelete.Text + grdInvoiceDetails.DataKeys[j].Value.ToString();
                    //------------------------------------
        ...
        private void DeleteInvoiceLineFromXML(int dataTableItemIndex)
        {
            ...
            if (System.IO.File.Exists(Session["XMLInvoiceHeadFile_CN"].ToString()))
            {
                ...
                while (!rs.EOF())
                {
                    ...
                    if (rs["TotalAmt"] != DBNull.Value && rs["TotalAmt"] != "")
                ...
                //rs["TotalAmt"] = totalAmt - headDiscountPercent / 100 *  ;
        ...
        private void btnCancel_Click(object sender, System.EventArgs e)
        {
            ...
            #region Blocked by Koushik Das as on 06-Apr-2017
            /*
            //Response.Redirect("../../GordonRamsay/history/history.aspx");
            //=======Commeneted by Rimi on 17thJuly2015===================
            ...
            //---------------------------Added by Rimi on 06.07.2015 End--------------------------------------------
            */
            #endregion

            #region Applied by Koushik Das as on 06-Apr-2017
            if (Request.QueryString["IsParentReload"] != null && Convert.ToInt32(Request.QueryString["IsParentReload"].ToString()) == 1)
            {
                // If Condition Added by Mrinal on 3rd January 2015
                Response.Write("<script>opener.location.reload();</script>");
        ...
        private void btnCalculate_Click(object sender, System.EventArgs e)
        {
            ...
            iUrlJS = Request.Url.ToString();//strUrl;

            // if(Session["txtNetTotal"]!=null && (Session["txtTotAmt"]!=null && Session["txtVATAmtNew"]!=null)
            //{
            txtNetTotal.Text = Convert.ToString(Session["txtNetTotal"]);
            txtTotAmt.Text = Convert.ToString(Session["txtTotAmt"]);
            txtVATAmtNew.Text = Convert.ToString(Session["txtVATAmtNew"]);
            //}
        }
        ...
        //private void AutoUpdateOtherFieldsinXML(int dataTableItemIndex ,decimal PPrice ,decimal Qty, decimal PVat)
        private void AutoUpdateOtherFieldsinXML()
        {
            ...
            for (int j = 0; j < grdInvoiceDetails.Rows.Count; j++)
            {
                ...
                DataRow myRow;
                //myRow = dt.Rows[dataTableItemIndex];
                myRow = dt.Rows[j];
                myRow.BeginEdit();
                ...
                //myRow["TotalAmt"] = Convert.ToString(Convert.ToDecimal(myRow["New_NettValue"])+PVat); 
                ...
                myRow["VATRate"] = Convert.ToDecimal(PVATRate).ToString("#0.00");
                ...
                {
                    // myRow["PurOrderLineNo"] = DBNull.Value;//Added by Mainak 2018-08-31
                    myRow["PurOrderLineNo"] = DBNull.Value;
                }
                else
                {
                    myRow["PurOrderLineNo"] = Convert.ToString(tbPOLineNo.Text);
            ...
            //Response.Write("<script language=javascript>window.opener.location.reload( false );</script>");
            UpdateAmountsinHeaderXML(dNetValue, VATAmt, totalAmt);
        }
        #endregion
        ...
        public void UpdateAmountsinHeaderXML(decimal dNetValue, decimal VATAmt, decimal totalAmt)
        {
            if (System.IO.File.Exists(Session["XMLInvoiceHeadFile_CN"].ToString()))
            {
                ...
                Session.Add("txtNetTotal", System.Convert.ToDouble(rsHead1["NetTotal"]).ToString("#0.00"));
                txtTotAmt.Text = System.Convert.ToDouble(rsHead1["TotalAmt"]).ToString("#0.00");
                Session.Add("txtTotAmt", System.Convert.ToDouble(rsHead1["TotalAmt"]).ToString("#0.00"));
                txtVATAmtNew.Text = System.Convert.ToDouble(rsHead1["VATAmt"]).ToString("#0.00");
                Session.Add("txtVATAmtNew", System.Convert.ToDouble(rsHead1["VATAmt"]).ToString("#0.00"));
            }
        }
        #endregion
        ...
        private void inpAddLine_ServerClick(object sender, System.EventArgs e)
        {
            ...
            Response.Redirect("InvoiceDetailAdd_CN.aspx?InvoiceID=" + invoiceID + "&AllowEdit=" + Request.QueryString["AllowEdit"].ToString());
        ...
        private void PopulateSuppAddress(int CompanyID, string VATRegNo)
        {
            ...
            DSADD = objInvoiceSupp.GetSupplierAddress(CompanyID);
        ...
        protected void btnAddModal_Click(object sender, EventArgs e)
        {
            ...
            if (test != "")
            {
                ...
                foreach (GridViewRow row in grdInvoiceDetails.Rows)
                {
                    ...
                    if (VATAmt_temp == "" || VATAmt_temp == null || VATAmt_temp == "Select")
                    {
                        VATAmt_temp = "0";
                    }
                ...
                grdInvoiceDetails.DataSource = dt;
                grdInvoiceDetails.DataBind();
                dt.WriteXmlSchema(Session["XSDInvoiceDetailFile_CN"].ToString());
                dt.WriteXml(Session["XMLInvoiceDetailFile_CN"].ToString());
