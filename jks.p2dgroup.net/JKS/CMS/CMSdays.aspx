<%@ Page Language="c#" CodeBehind="CMSdays.aspx.cs" AutoEventWireup="false" Inherits="CBSolutions.ETH.Web.ETC.CMS.CMSdays" %>
...
<head>
    ...
    <link type="text/css" href="../../Utilities/ETH.css" rel="stylesheet">
    ...
    <script language="javascript">
        ...
        function fnCheck() {
            ...
            if (r == true) {
                window.location.href = 'WeeklySummary.aspx?dep=' + getQuerystring('dep');
            }
        }
