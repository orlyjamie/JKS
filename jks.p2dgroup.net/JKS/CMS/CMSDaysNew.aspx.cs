...
{
    /// <summary>
    /// Summary description for CMSDaysNew.
    /// </summary>
    public class CMSDaysNew : System.Web.UI.Page
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string CMSWeekIDNew = Convert.ToString(Session["CMSWeekIDNew"]);
                string[] strCMSWeekIDNew = CMSWeekIDNew.Split(separator);
                if (strCMSWeekIDNew.Length > 1)
                {
                    ViewState["Check"] = "0";
                    for (int i = 0; i < strCMSWeekIDNew.Length; i++)
                    {
                        LoadData(Convert.ToInt32(strSplit[i]), Convert.ToInt32(Request.QueryString["icon"]), Convert.ToInt32(strCMSWeekIDNew[i]));
                    }
                }
                else
                {
                    ViewState["Check"] = "1";
                    LoadData(Convert.ToInt32(strSplit[0]), Convert.ToInt32(Request.QueryString["icon"]), Convert.ToInt32(strCMSWeekIDNew[0]));
                }
        ...
        private void btnSave_ServerClick(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                if (iReturnValue > 0)
                {
                    ...
                    LoadData(Convert.ToInt32(Session["DepartmentID"]), Convert.ToInt32(Request.QueryString["icon"]), Convert.ToInt32(Session["CMSWeekIDNew"]));
                }
                else
                {
        ...
        private void LoadData(int depID, int dayid, int CMSWeekID)
        {
            ...
            dap.SelectCommand.CommandType = CommandType.StoredProcedure;
            dap.SelectCommand.Parameters.Add("@CMSWeekID", Convert.ToInt32(CMSWeekID));
            ...
            try
            {
                ...
                if (ds.Tables[3].Rows.Count > 0)
                {
                    ...
                    if (Convert.ToString(txtCovers1.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Covers1"]) != "")
                        txtCovers1.Value = Convert.ToString(ds.Tables[3].Rows[0]["Covers1"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Covers1"]) != "")
                        txtCovers1.Value = Convert.ToString(Convert.ToInt32(txtCovers1.Value) + Convert.ToInt32(ds.Tables[3].Rows[0]["Covers1"]));

                    if (Convert.ToString(txtCovers2.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Covers2"]) != "")
                        txtCovers2.Value = Convert.ToString(ds.Tables[3].Rows[0]["Covers2"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Covers2"]) != "")
                        txtCovers2.Value = Convert.ToString(Convert.ToInt32(txtCovers2.Value) + Convert.ToInt32(ds.Tables[3].Rows[0]["Covers2"]));

                    if (Convert.ToString(txtCovers3.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Covers3"]) != "")
                        txtCovers3.Value = Convert.ToString(ds.Tables[3].Rows[0]["Covers3"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Covers3"]) != "")
                        txtCovers3.Value = Convert.ToString(Convert.ToInt32(txtCovers3.Value) + Convert.ToInt32(ds.Tables[3].Rows[0]["Covers3"]));

                    if (Convert.ToString(txtField1.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field1"]) != "")
                        txtField1.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field1"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field1"]) != "")
                        txtField1.Value = Convert.ToString(Convert.ToDecimal(txtField1.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field1"]));

                    if (Convert.ToString(txtField2.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field2"]) != "")
                        txtField2.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field2"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field2"]) != "")
                        txtField2.Value = Convert.ToString(Convert.ToDecimal(txtField2.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field2"]));

                    if (Convert.ToString(txtField3.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field3"]) != "")
                        txtField3.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field3"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field3"]) != "")
                        txtField3.Value = Convert.ToString(Convert.ToDecimal(txtField3.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field3"]));

                    if (Convert.ToString(txtField4.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field4"]) != "")
                        txtField4.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field4"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field4"]) != "")
                        txtField4.Value = Convert.ToString(Convert.ToDecimal(txtField4.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field4"]));

                    if (Convert.ToString(txtField5.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field5"]) != "")
                        txtField5.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field5"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field5"]) != "")
                        txtField5.Value = Convert.ToString(Convert.ToDecimal(txtField5.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field5"]));

                    if (Convert.ToString(txtField6.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field6"]) != "")
                        txtField6.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field6"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field6"]) != "")
                        txtField6.Value = Convert.ToString(Convert.ToDecimal(txtField6.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field6"]));

                    if (Convert.ToString(txtField7.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field7"]) != "")
                        txtField7.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field7"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field7"]) != "")
                        txtField7.Value = Convert.ToString(Convert.ToDecimal(txtField7.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field7"]));


                    if (Convert.ToString(txtField8.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field8"]) != "")
                        txtField8.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field8"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field8"]) != "")
                        txtField8.Value = Convert.ToString(Convert.ToDecimal(txtField8.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field8"]));


                    if (Convert.ToString(txtField9.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field9"]) != "")
                        txtField9.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field9"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field9"]) != "")
                        txtField9.Value = Convert.ToString(Convert.ToDecimal(txtField9.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field9"]));

                    if (Convert.ToString(txtField10.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field10"]) != "")
                        txtField10.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field10"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field10"]) != "")
                        txtField10.Value = Convert.ToString(Convert.ToDecimal(txtField10.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field10"]));

                    if (Convert.ToString(txtField11.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field11"]) != "")
                        txtField11.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field11"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field11"]) != "")
                        txtField11.Value = Convert.ToString(Convert.ToDecimal(txtField11.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field11"]));

                    if (Convert.ToString(txtField12.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field12"]) != "")
                        txtField12.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field12"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field12"]) != "")
                        txtField12.Value = Convert.ToString(Convert.ToDecimal(txtField12.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field12"]));

                    if (Convert.ToString(txtField13.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field13"]) != "")
                        txtField13.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field13"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field13"]) != "")
                        txtField13.Value = Convert.ToString(Convert.ToDecimal(txtField13.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field13"]));

                    if (Convert.ToString(txtField14.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field14"]) != "")
                        txtField14.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field14"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field14"]) != "")
                        txtField14.Value = Convert.ToString(Convert.ToDecimal(txtField14.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field14"]));

                    if (Convert.ToString(txtField15.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["Field15"]) != "")
                        txtField15.Value = Convert.ToString(ds.Tables[3].Rows[0]["Field15"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["Field15"]) != "")
                        txtField15.Value = Convert.ToString(Convert.ToDecimal(txtField15.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["Field15"]));

                    if (Convert.ToString(txtPettyCashTotal.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashTotal"]) != "")
                        txtPettyCashTotal.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashTotal"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashTotal"]) != "")
                        txtPettyCashTotal.Value = Convert.ToString(Convert.ToDecimal(txtPettyCashTotal.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashTotal"]));


                    if (Convert.ToString(txtVAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["vat"]) != "")
                        txtVAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["vat"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["vat"]) != "")
                        txtVAT.Value = Convert.ToString(Convert.ToDecimal(txtVAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["vat"]));

                    //------------------------------------------
                    if (Convert.ToString(txtPettycash1Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet1"]) != "")
                        txtPettycash1Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet1"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet1"]) != "")
                        txtPettycash1Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash1Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet1"]));

                    if (Convert.ToString(txtPettycash1VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT1"]) != "")
                        txtPettycash1VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT1"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT1"]) != "")
                        txtPettycash1VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash1VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT1"]));

                    if (Convert.ToString(txtPettycash1Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross1"]) != "")
                        txtPettycash1Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross1"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross1"]) != "")
                        txtPettycash1Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash1Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross1"]));

                    if (Convert.ToString(txtPettycash1Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription1"]) != "")
                        txtPettycash1Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription1"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription1"]) != "")
                        txtPettycash1Description.Value = Convert.ToString(txtPettycash1Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription1"]);

                    //--2
                    if (Convert.ToString(txtPettycash2Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet2"]) != "")
                        txtPettycash2Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet2"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet2"]) != "")
                        txtPettycash2Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash2Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet2"]));

                    if (Convert.ToString(txtPettycash2VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT2"]) != "")
                        txtPettycash2VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT2"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT2"]) != "")
                        txtPettycash2VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash2VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT2"]));

                    if (Convert.ToString(txtPettycash2Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross2"]) != "")
                        txtPettycash2Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross2"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross2"]) != "")
                        txtPettycash2Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash2Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross2"]));

                    if (Convert.ToString(txtPettycash2Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription2"]) != "")
                        txtPettycash2Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription2"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription2"]) != "")
                        txtPettycash2Description.Value = Convert.ToString(txtPettycash2Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription2"]);

                    //--3
                    if (Convert.ToString(txtPettycash3Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet3"]) != "")
                        txtPettycash3Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet3"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet3"]) != "")
                        txtPettycash3Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash3Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet3"]));

                    if (Convert.ToString(txtPettycash3VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT3"]) != "")
                        txtPettycash3VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT3"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT3"]) != "")
                        txtPettycash3VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash3VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT3"]));

                    if (Convert.ToString(txtPettycash3Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross3"]) != "")
                        txtPettycash3Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross3"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross3"]) != "")
                        txtPettycash3Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash3Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross3"]));

                    if (Convert.ToString(txtPettycash3Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription3"]) != "")
                        txtPettycash3Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription3"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription3"]) != "")
                        txtPettycash3Description.Value = Convert.ToString(txtPettycash3Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription3"]);

                    //--4
                    if (Convert.ToString(txtPettycash4Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet4"]) != "")
                        txtPettycash4Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet4"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet4"]) != "")
                        txtPettycash4Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash4Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet4"]));

                    if (Convert.ToString(txtPettycash4VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT4"]) != "")
                        txtPettycash4VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT4"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT4"]) != "")
                        txtPettycash4VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash4VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT4"]));

                    if (Convert.ToString(txtPettycash4Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross4"]) != "")
                        txtPettycash4Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross4"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross4"]) != "")
                        txtPettycash4Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash4Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross4"]));

                    if (Convert.ToString(txtPettycash4Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription4"]) != "")
                        txtPettycash4Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription4"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription4"]) != "")
                        txtPettycash4Description.Value = Convert.ToString(txtPettycash4Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription4"]);
                    //--5
                    if (Convert.ToString(txtPettycash5Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet5"]) != "")
                        txtPettycash5Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet5"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet5"]) != "")
                        txtPettycash5Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash5Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet5"]));

                    if (Convert.ToString(txtPettycash5VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT5"]) != "")
                        txtPettycash5VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT5"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT5"]) != "")
                        txtPettycash5VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash5VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT5"]));

                    if (Convert.ToString(txtPettycash5Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross5"]) != "")
                        txtPettycash5Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross5"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross5"]) != "")
                        txtPettycash5Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash5Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross5"]));

                    if (Convert.ToString(txtPettycash5Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription5"]) != "")
                        txtPettycash5Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription5"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription5"]) != "")
                        txtPettycash5Description.Value = Convert.ToString(txtPettycash5Description.Value) + "," + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashDescription5"]);
                    //--6
                    if (Convert.ToString(txtPettycash6Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet6"]) != "")
                        txtPettycash6Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet6"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet6"]) != "")
                        txtPettycash6Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash6Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet6"]));

                    if (Convert.ToString(txtPettycash6VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT6"]) != "")
                        txtPettycash6VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT6"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT6"]) != "")
                        txtPettycash6VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash6VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT6"]));

                    if (Convert.ToString(txtPettycash6Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross6"]) != "")
                        txtPettycash6Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross6"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross6"]) != "")
                        txtPettycash6Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash6Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross6"]));

                    if (Convert.ToString(txtPettycash6Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription6"]) != "")
                        txtPettycash6Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription6"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription6"]) != "")
                        txtPettycash6Description.Value = Convert.ToString(txtPettycash6Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription6"]);
                    //--7
                    if (Convert.ToString(txtPettycash7Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet7"]) != "")
                        txtPettycash7Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet7"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet7"]) != "")
                        txtPettycash7Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash7Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet7"]));

                    if (Convert.ToString(txtPettycash7VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT7"]) != "")
                        txtPettycash7VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT7"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT7"]) != "")
                        txtPettycash7VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash7VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT7"]));

                    if (Convert.ToString(txtPettycash7Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross7"]) != "")
                        txtPettycash7Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross7"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross7"]) != "")
                        txtPettycash7Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash7Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross7"]));

                    if (Convert.ToString(txtPettycash7Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription7"]) != "")
                        txtPettycash7Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription7"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription7"]) != "")
                        txtPettycash7Description.Value = Convert.ToString(txtPettycash7Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription7"]);
                    //--8
                    if (Convert.ToString(txtPettycash8Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet8"]) != "")
                        txtPettycash8Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet8"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet8"]) != "")
                        txtPettycash8Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash8Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet8"]));

                    if (Convert.ToString(txtPettycash8VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT8"]) != "")
                        txtPettycash8VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT8"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT8"]) != "")
                        txtPettycash8VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash8VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT8"]));

                    if (Convert.ToString(txtPettycash8Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross8"]) != "")
                        txtPettycash8Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross8"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross8"]) != "")
                        txtPettycash8Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash8Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross8"]));

                    if (Convert.ToString(txtPettycash8Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription8"]) != "")
                        txtPettycash8Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription8"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription8"]) != "")
                        txtPettycash8Description.Value = Convert.ToString(txtPettycash8Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription8"]);
                    //--9
                    if (Convert.ToString(txtPettycash9Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet9"]) != "")
                        txtPettycash9Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet9"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet9"]) != "")
                        txtPettycash9Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash9Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet9"]));

                    if (Convert.ToString(txtPettycash9VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT9"]) != "")
                        txtPettycash9VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT9"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT9"]) != "")
                        txtPettycash9VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash9VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT9"]));

                    if (Convert.ToString(txtPettycash9Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross9"]) != "")
                        txtPettycash9Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross9"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross9"]) != "")
                        txtPettycash9Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash9Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross9"]));

                    if (Convert.ToString(txtPettycash9Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription9"]) != "")
                        txtPettycash9Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription9"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription9"]) != "")
                        txtPettycash9Description.Value = Convert.ToString(txtPettycash9Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription9"]);
                    //--10
                    if (Convert.ToString(txtPettycash10Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet10"]) != "")
                        txtPettycash10Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet10"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet10"]) != "")
                        txtPettycash10Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash10Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet10"]));

                    if (Convert.ToString(txtPettycash10VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT10"]) != "")
                        txtPettycash10VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT10"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT10"]) != "")
                        txtPettycash10VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash10VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT10"]));

                    if (Convert.ToString(txtPettycash10Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross10"]) != "")
                        txtPettycash10Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross10"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross10"]) != "")
                        txtPettycash10Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash10Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross10"]));

                    if (Convert.ToString(txtPettycash10Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription10"]) != "")
                        txtPettycash10Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription10"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription10"]) != "")
                        txtPettycash10Description.Value = Convert.ToString(txtPettycash10Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription10"]);
                    //--11
                    if (Convert.ToString(txtPettycash11Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet11"]) != "")
                        txtPettycash11Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet11"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet11"]) != "")
                        txtPettycash11Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash11Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet11"]));

                    if (Convert.ToString(txtPettycash11VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT11"]) != "")
                        txtPettycash11VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT11"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT11"]) != "")
                        txtPettycash11VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash11VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT11"]));

                    if (Convert.ToString(txtPettycash11Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross11"]) != "")
                        txtPettycash11Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross11"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross11"]) != "")
                        txtPettycash11Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash11Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross11"]));

                    if (Convert.ToString(txtPettycash11Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription11"]) != "")
                        txtPettycash11Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription11"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription11"]) != "")
                        txtPettycash11Description.Value = Convert.ToString(txtPettycash11Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription11"]);
                    //--12
                    if (Convert.ToString(txtPettycash12Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet12"]) != "")
                        txtPettycash12Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet12"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet12"]) != "")
                        txtPettycash12Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash12Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet12"]));

                    if (Convert.ToString(txtPettycash12VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT12"]) != "")
                        txtPettycash12VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT12"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT12"]) != "")
                        txtPettycash12VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash12VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT12"]));

                    if (Convert.ToString(txtPettycash12Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross12"]) != "")
                        txtPettycash12Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross12"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross12"]) != "")
                        txtPettycash12Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash12Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross12"]));

                    if (Convert.ToString(txtPettycash12Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription12"]) != "")
                        txtPettycash12Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription12"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription12"]) != "")
                        txtPettycash12Description.Value = Convert.ToString(txtPettycash12Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription12"]);
                    //--13
                    if (Convert.ToString(txtPettycash13Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet13"]) != "")
                        txtPettycash13Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet13"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet13"]) != "")
                        txtPettycash13Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash13Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet13"]));

                    if (Convert.ToString(txtPettycash13VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT13"]) != "")
                        txtPettycash13VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT13"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT13"]) != "")
                        txtPettycash13VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash13VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT13"]));

                    if (Convert.ToString(txtPettycash13Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross13"]) != "")
                        txtPettycash13Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross13"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross13"]) != "")
                        txtPettycash13Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash13Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross13"]));

                    if (Convert.ToString(txtPettycash13Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription13"]) != "")
                        txtPettycash13Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription13"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription13"]) != "")
                        txtPettycash13Description.Value = Convert.ToString(txtPettycash13Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription13"]);
                    //--14
                    if (Convert.ToString(txtPettycash14Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet14"]) != "")
                        txtPettycash14Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet14"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet14"]) != "")
                        txtPettycash14Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash14Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet14"]));

                    if (Convert.ToString(txtPettycash14VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT14"]) != "")
                        txtPettycash14VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT14"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT14"]) != "")
                        txtPettycash14VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash14VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT14"]));

                    if (Convert.ToString(txtPettycash14Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross14"]) != "")
                        txtPettycash14Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross14"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross14"]) != "")
                        txtPettycash14Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash14Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross14"]));

                    if (Convert.ToString(txtPettycash14Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription14"]) != "")
                        txtPettycash14Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription14"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription14"]) != "")
                        txtPettycash14Description.Value = Convert.ToString(txtPettycash14Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription14"]);
                    //--15
                    if (Convert.ToString(txtPettycash15Net.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet15"]) != "")
                        txtPettycash15Net.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet15"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashNet15"]) != "")
                        txtPettycash15Net.Value = Convert.ToString(Convert.ToDecimal(txtPettycash15Net.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashNet15"]));

                    if (Convert.ToString(txtPettycash15VAT.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT15"]) != "")
                        txtPettycash15VAT.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT15"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashVAT15"]) != "")
                        txtPettycash15VAT.Value = Convert.ToString(Convert.ToDecimal(txtPettycash15VAT.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashVAT15"]));

                    if (Convert.ToString(txtPettycash15Gross.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross15"]) != "")
                        txtPettycash15Gross.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross15"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashGross15"]) != "")
                        txtPettycash15Gross.Value = Convert.ToString(Convert.ToDecimal(txtPettycash15Gross.Value) + Convert.ToDecimal(ds.Tables[3].Rows[0]["PettyCashGross15"]));

                    if (Convert.ToString(txtPettycash15Description.Value) == "" && Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription15"]) != "")
                        txtPettycash15Description.Value = Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription15"]);
                    else if (Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription15"]) != "")
                        txtPettycash15Description.Value = Convert.ToString(txtPettycash15Description.Value) + "," + Convert.ToString(ds.Tables[3].Rows[0]["PettyCashDescription15"]);
            ...
            {
                CMScode.SendEmail("support@p2dgroup.com", "rjaiswal@vnsinfo.com.au", "", "", "CMS ERROR", "CMS DayNew LoadData : <br /> " + ex.Message.ToString());
            }
            finally
            {
                ds = null;
