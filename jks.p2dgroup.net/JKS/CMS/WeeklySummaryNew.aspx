<%@ Page Language="c#" CodeBehind="WeeklySummaryNew.aspx.cs" AutoEventWireup="false"
    Inherits="CBSolutions.ETH.Web.ETC.CMS.WeeklySummaryNew" %>
                        ...
                        <td>
                            <table class="hed" cellspacing="0" cellpadding="0" style="width: 700px">
                                <tr>
                                    ...
                                    <td align="right">
                                        <input id="txtDateClosed" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="DateClosed" runat="server">
                                    </td>
                                    <td style="width: 63px" align="right">
                                        <strong>Status</strong>
                                    </td>
                                    <td align="right">
                                        <input id="txtStatus" style="text-align: center; float: none; font-weight: bold"
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <input id="txtClosedBy" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="Closedby" runat="server">
                                    </td>
                                    <td style="width: 63px">
                                    </td>
                                    <td align="right">
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtTotal" style="text-align: center; float: none; font-weight: bold"
                                            readonly value="TOTAL" name="TOTAL">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input id="txtMonday" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="txtMonday" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesday" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="txtTuesday" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednessday" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="txtWednessday" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTursday" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="txtTursday" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFriday" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="txtFriday" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturday" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="txtSaturday" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSunday" style="text-align: center; float: none; font-weight: bold"
                                            readonly name="txtSunday" runat="server">
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayStatus" style="text-align: center; float: none; font-weight: bold"
                                            readonly value="OVER-BANKED" name="txtMondayStatus" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayStatus" style="text-align: center; float: none; font-weight: bold"
                                            value="UNDER-BANKED" name="txtTuesdayStatus" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednessdayStatus" style="text-align: center; float: none; font-weight: bold"
                                            value="BALANCED" name="txtWednessdayStatus" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayStatus" style="text-align: center; float: none; font-weight: bold"
                                            readonly value="BALANCED" name="txtThursdayStatus" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayStatus" style="text-align: center; float: none; font-weight: bold"
                                            readonly value="BALANCED" name="txtFridayStatus" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayStatus" style="text-align: center; float: none; font-weight: bold"
                                            readonly value="BALANCED" name="txtSaturdayStatus" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayStatus" style="text-align: center; float: none; font-weight: bold"
                                            readonly value="BALANCED" name="txtSundayStatus" runat="server">
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayCover1" readonly value="-" name="txtMondayCover1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayCover1" readonly value="-" name="txtTuesdayCover1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayCover1" readonly value="-" name="txtWednesdayCover1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayCover1" readonly value="-" name="txtThursdayCover1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayCover1" readonly value="-" name="txtFridayCover1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayCover1" readonly value="-" name="txtSaturdayCover1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayCover1" readonly value="-" name="txtSundayCover1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalCover1" style="font-weight: bold" readonly value="-" name="txtTotalCover1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayCover2" readonly value="-" name="txtMondayCover2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayCover2" readonly value="-" name="txtTuesdayCover2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayCover2" readonly value="-" name="txtWednesdayCover2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayCover2" readonly value="-" name="txtThursdayCover2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayCover2" readonly value="-" name="txtFridayCover2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayCover2" readonly value="-" name="txtSaturdayCover2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayCover2" readonly value="-" name="txtSundayCover2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalCover2" style="font-weight: bold" readonly value="-" name="txtTotalCover2"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayCover3" readonly value="-" name="txtMondayCover3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayCover3" readonly value="-" name="txtTuesdayCover3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayCover3" readonly value="-" name="txtWednesdayCover3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayCover3" readonly value="-" name="txtThursdayCover3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayCover3" readonly value="-" name="txtFridayCover3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayCover3" readonly value="-" name="txtSaturdayCover3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayCover3" readonly value="-" name="txtSundayCover3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalCover3" style="font-weight: bold" readonly value="-" name="txtTotalCover3"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayTotalCover" style="font-weight: bold" readonly value="0" name="txtMondayTotalCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayTotalCover" style="font-weight: bold" readonly value="0" name="txtTuesdayTotalCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayTotalCover" style="font-weight: bold" readonly value="0" name="txtWednesdayTotalCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayTotalCover" style="font-weight: bold" readonly value="0" name="txtThursdayTotalCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayTotalCover" style="font-weight: bold" readonly value="0" name="txtFridayTotalCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayTotalCover" style="font-weight: bold" readonly value="0" name="txtSaturdayTotalCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayTotalCover" style="font-weight: bold" readonly value="0" name="txtSundayTotalCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalCover" style="font-weight: bold" readonly value="0" name="txtTotalCover"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayAverageCover" style="font-weight: bold" readonly value="0" name="txtMondayAverageCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayAverageCover" style="font-weight: bold" readonly value="0" name="txtTuesdayAverageCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayAverageCover" style="font-weight: bold" readonly value="0"
                                            name="txtWednesdayAverageCover" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayAverageCover" style="font-weight: bold" readonly value="0"
                                            name="txtThursdayAverageCover" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayAverageCover" style="font-weight: bold" readonly value="0" name="txtFridayAverageCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayAverageCoverame" style="font-weight: bold" readonly value="0"
                                            name="txtSaturdayAverageCoverame" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayAverageCover" style="font-weight: bold" readonly value="0" name="txtSundayAverageCover"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtAverageCover" style="font-weight: bold" readonly value="0" name="txtAverageCover"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField1" readonly value="-" name="txtMondayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField1" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField1" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField1" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField1" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField1" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField1" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField1" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField2" readonly value="-" name="txtMondayField2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField2" readonly value="-" name="txtTuesdayField2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField2" readonly value="-" name="txtWednesdayField2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField2" readonly value="-" name="txtThursdayField2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField2" readonly value="-" name="txtFridayField2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField2" readonly value="-" name="txtSaturdayField2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField2" readonly value="-" name="txtSundayField2" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField2" style="font-weight: bold" readonly value="0" name="txtTotalField2"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField3" readonly value="-" name="txtMondayField3" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField3" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField3" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField3" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField3" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField3" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField3" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField3" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField4" readonly value="-" name="txtMondayField4" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField4" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField4" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField4" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField4" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField4" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField4" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField4" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField5" readonly value="-" name="txtMondayField5" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField5" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField5" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField5" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField5" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField5" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField5" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField5" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField6" readonly value="-" name="txtMondayField6" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField6" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField6" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField6" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField6" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField6" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField6" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField6" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField7" readonly value="-" name="txtMondayField7" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField7" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField7" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField7" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField7" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField7" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField7" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField7" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayTotalNet" style="font-weight: bold" readonly value="0" name="txtMondayTotalNet"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayTotalNet" style="font-weight: bold" readonly value="0" name="txtTuesdayTotalNet"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayTotalNet" style="font-weight: bold" readonly value="0" name="txtWednesdayTotalNet"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayTotalNet" style="font-weight: bold" readonly value="0" name="txtThursdayTotalNet"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayTotalNet" style="font-weight: bold" readonly value="0" name="txtFridayTotalNet"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayTotalNet" style="font-weight: bold" readonly value="0" name="txtSaturdayTotalNet"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayTotalNet" style="font-weight: bold" readonly value="0" name="txtSundayTotalNet"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalTotalNet" style="font-weight: bold" readonly value="0" name="txtTotalTotalNet"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayVat" readonly value="-" name="txtMondayVat" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayVat" readonly value="-" name="txtTuesdayVat" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayVat" readonly value="-" name="txtWednesdayVat" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayVat" readonly value="-" name="txtThursdayVat" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayVat" readonly value="-" name="txtFridayVat" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayVat" readonly value="-" name="txtSaturdayVat" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayVat" readonly value="-" name="txtSundayVat" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalVat" style="font-weight: bold" readonly value="0" name="txtTotalTotalNet"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayTotalGross" style="font-weight: bold" readonly value="0" name="txtMondayTotalGross"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayTotalGross" style="font-weight: bold" readonly value="0" name="txtTuesdayTotalGross"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayTotalGross" style="font-weight: bold" readonly value="0" name="txtWednesdayTotalGross"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayTotalGross" style="font-weight: bold" readonly value="0" name="txtThursdayTotalGross"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayTotalGross" style="font-weight: bold" readonly value="0" name="txtFridayTotalGross"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayTotalGross" style="font-weight: bold" readonly value="0" name="txtSaturdayTotalGross"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayTotalGross" style="font-weight: bold" readonly value="0" name="txtSundayTotalGross"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalTotalGross" style="font-weight: bold" readonly value="0" name="txtTotalTotalNet"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField8" readonly value="-" name="txtMondayField8" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField8" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField8" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField8" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField8" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField8" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField8" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField8" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField9" readonly value="-" name="txtMondayField9" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField9" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField9" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField9" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField9" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField9" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField9" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField9" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField10" readonly value="-" name="txtMondayField10" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField10" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField10" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField10" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField10" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField10" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField10" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField10" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField11" readonly value="-" name="txtMondayField11" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField11" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField11" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField11" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField11" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField11" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField11" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField11" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField12" readonly value="-" name="txtMondayField12" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField12" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField12" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField12" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField12" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField12" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField12" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField12" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField13" readonly value="-" name="txtMondayField13" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField13" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField13" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField13" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField13" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField13" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField13" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField13" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField14" readonly value="-" name="txtMondayField14" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField14" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField14" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField14" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField14" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField14" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField14" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField14" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayField15" readonly value="-" name="txtMondayField15" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayField15" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayField15" readonly value="-" name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayField15" readonly value="-" name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayField15" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayField15" readonly value="-" name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayField15" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalField15" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayPettyCashTotal" readonly value="-" name="txtMondayPettyCashTotal"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayPettyCashTotal" readonly value="-" name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayPettyCashTotal" readonly value="-" name="txtWednesdayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayPettyCashTotal" readonly value="-" name="txtThursdayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayPettyCashTotal" readonly value="-" name="txtFridayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayPettyCashTotal" readonly value="-" name="txtSaturdayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayPettyCashTotal" readonly value="-" name="txtSundayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalPettyCashTotal" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayFieldTotal" style="font-weight: bold" readonly value="0" name="txtMondayFieldTotal"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayFieldTotal" style="font-weight: bold" readonly value="0" name="txtTuesdayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayFieldTotal" style="font-weight: bold" readonly value="0" name="txtWednesdayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayFieldTotal" style="font-weight: bold" readonly value="0" name="txtThursdayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayFieldTotal" style="font-weight: bold" readonly value="0" name="txtFridayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayFieldTotal" style="font-weight: bold" readonly value="0" name="txtSaturdayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayFieldTotal" style="font-weight: bold" readonly value="0" name="txtSundayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalFieldTotal" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtMondayFieldVariance" style="font-weight: bold" readonly value="0" name="txtMondayFieldVariance"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTuesdayFieldVariance" style="font-weight: bold" readonly value="0"
                                            name="txtTuesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtWednesdayFieldVariance" style="font-weight: bold" readonly value="0"
                                            name="txtWednesdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtThursdayFieldVariance" style="font-weight: bold" readonly value="0"
                                            name="txtThursdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtFridayFieldVariance" style="font-weight: bold" readonly value="0" name="txtFridayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSaturdayFieldVariance" style="font-weight: bold" readonly value="0"
                                            name="txtSaturdayField1" runat="server">
                                    </td>
                                    <td>
                                        <input id="txtSundayFieldVariance" style="font-weight: bold" readonly value="0" name="txtSundayField1"
                                            runat="server">
                                    </td>
                                    <td>
                                        <input id="txtTotalFieldVariance" style="font-weight: bold" readonly value="0" name="txtTotalField1"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input class="box_input" id="txtStock1Opening" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock1Opening" runat="server">
                                    </td>
                                    <td align="left">
                                        <input class="box_input" id="txtStock1Closing" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock1Closing" runat="server">
                                    </td>
                                    <td align="left">
                                        <input id="txtStock1Movement" style="font-weight: bold" readonly value="0" name="txtStock1Movement"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <input class="box_input" id="txtStock2Opening" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock2Opening" runat="server">
                                    </td>
                                    <td align="left">
                                        <input class="box_input" id="txtStock2Closing" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock2Closing" runat="server">
                                    </td>
                                    <td align="left">
                                        <input id="txtStock2Movement" style="font-weight: bold" readonly value="0" name="txtStock2Movement"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <input class="box_input" id="txtStock3Opening" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock3Opening" runat="server">
                                    </td>
                                    <td align="left">
                                        <input class="box_input" id="txtStock3Closing" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock3Closing" runat="server">
                                    </td>
                                    <td align="left">
                                        <input id="txtStock3Movement" style="font-weight: bold" readonly value="0" name="txtStock3Movement"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <input class="box_input" id="txtStock4Opening" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock4Opening" runat="server">
                                    </td>
                                    <td align="left">
                                        <input class="box_input" id="txtStock4Closing" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:sumStock1();" name="txtStock4Closing" runat="server">
                                    </td>
                                    <td align="left">
                                        <input id="txtStock4Movement" style="font-weight: bold" readonly value="0" name="txtStock4Movement"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <input id="txtTotalOpening" style="font-weight: bold" readonly value="0" name="txtTotalOpening"
                                            runat="server">
                                    </td>
                                    <td align="left">
                                        <input id="txtTotalClosing" style="font-weight: bold" readonly value="0" name="txtTotalClosing"
                                            runat="server">
                                    </td>
                                    <td align="left">
                                        <input id="txtStockTotalMovement" style="font-weight: bold" readonly value="0" name="txtStockTotalMovement"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtLabour1" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour1();" name="txtLabour1" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtLabour4" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour4();" name="txtLabour4" runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input class="box_input" id="txtNationalInsurance1" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour1();" name="txtNationalInsurance1" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtNationalInsurance4" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour4();" name="txtNationalInsurance4" runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input id="txtTotalLabour1" style="font-weight: bold" readonly value="0" name="txtTotalLabour1"
                                            runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    ...
                                    <td>
                                        <input id="txtTotalLabour4" style="font-weight: bold" readonly value="0" name="txtTotalLabour4"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtLabour2" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour2();" name="txtLabour2" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtLabour5" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour5();" name="txtLabour5" runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input class="box_input" id="txtNationalInsurance2" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour2();" name="txtNationalInsurance2" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtNationalInsurance5" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour5();" name="txtNationalInsurance5" runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input id="txtTotalLabour2" style="font-weight: bold" readonly value="0" name="txtTotalLabour2"
                                            runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    ...
                                    <td>
                                        <input id="txtTotalLabour5" style="font-weight: bold" readonly value="0" name="txtTotalLabour5"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtLabour3" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour3();" name="txtLabour3" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input id="txtTotalLabour" style="font-weight: bold" readonly name="txtTotalLabour"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtNationalInsurance3" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:Labour3();" name="txtNationalInsurance3" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input id="txtTotalNationalInsurance" style="font-weight: bold" readonly name="txtTotalNationalInsurance"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtTotalLabour3" style="font-weight: bold" readonly name="txtTotalLabour3"
                                            runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    ...
                                    <td>
                                        <input id="txtTotalLabourCost" style="font-weight: bold" readonly name="txtTotalLabourCost"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="txtTotalLabourPercentage" style="font-weight: bold" readonly name="txtTotalLabourPercentage"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="hed3">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtStartersinWeek" name="txtStartersinWeek" onkeydown="javascript:return ValidationForCover(this,event);;"
                                            runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    ...
                                    <td>
                                        <input class="box_input" id="txtLeaversinWeek" name="txtLeaversinWeek" onkeydown="javascript:return ValidationForCover(this,event);;"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtFloatOpening" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:FloatOpening();" name="txtFloatOpening" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtSafeOpening" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:SafeOpening();" name="txtSafeOpening" runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input class="box_input" id="txtFloatIncrease" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:FloatOpening();" name="txtFloatIncrease" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtSafeIncrease" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:SafeOpening();" name="txtSafeIncrease" runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input id="txtFloatClosing" style="font-weight: bold" readonly value="0" name="txtFloatClosing"
                                            runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    ...
                                    <td>
                                        <input id="txtSafeClosing" style="font-weight: bold" readonly value="0" name="txtSafeClosing"
                                            runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtFixedFloat" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:FloatFixed();" name="txtFixedFloat" runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <input class="box_input" id="txtFixedSafe" onkeydown="javascript:return ValidationForTwoDecimalPoint(this,event);;"
                                            onkeyup="javascript:SafeFixed();" name="txtFixedSafe" runat="server">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="151">
                                    ...
                                    <td>
                                        <input id="txtFloatVariance" style="font-weight: bold" readonly value="0" name="txtFloatVariance"
                                            runat="server">
                                    </td>
                                    <td width="92">
                                        &nbsp;
                                    ...
                                    <td>
                                        <input id="txtSafeVariance" style="font-weight: bold" readonly value="0" name="txtSafeVariance"
                                            runat="server">
                                    </td>
                                </tr>
                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtSavedBy" style="text-align: center; float: none; font-weight: bold"
                                                readonly name="name" runat="server">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="151">
                                        ...
                                        <td>
                                            <input id="SaveDate" style="text-align: center; float: none; font-weight: bold" readonly
