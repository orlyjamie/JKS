...
namespace CBSolutions.ETH.Web.DebitNote
{
    public class DebitNoteNL : ActiveReport
    {
        ...
        {
            //rsDebitNoteNL = rsDebitNote;
            ds2 = ds;
            InitializeReport();
        }
        #endregion
        //======================================================================
        #region DebitNoteNL_DataInitialize
        private void DebitNoteNL_DataInitialize(object sender, System.EventArgs eArgs)
        {
            #region Add Fields  TARAKESHWAR DATE 31-AUG-2006
            ...
            dGBPEquivalentAmount = objInvoice.GetGBPEquivalentAmount(Convert.ToInt32(rsDebitNoteNL["InvoiceID"]));
        ...
        private void DebitNoteNL_FetchData(object sender, DataDynamics.ActiveReports.ActiveReport.FetchEventArgs eArgs)
        {
            ...
            for (i = 0; i < ds2.Tables[1].Rows.Count; i++)
            {
                ...
                //if(ds2.Tables[1].Rows[i]["TotalAmt"] != DBNull.Value)
                //	Fields["TotalAmt"].Value = ds2.Tables[1].Rows[i]["TotalAmt"] ;           
        ...
        {
            this.LoadLayout(this.GetType(), "CBSolutions.ETH.Web.DebitNote.DebitNoteNL.rpx");
