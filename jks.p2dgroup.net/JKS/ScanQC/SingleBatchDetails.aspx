<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SingleBatchDetails.aspx.cs" Inherits="NewLook.NewLook_ScanQC_SingleBatchDetails" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        ...
        <style type="text/css">
            ...
            .row-style:hover{ background-color: #afc8ff !important; font-weight:bold !important; color: #000000 !important; }
            .row-style:hover td{ color: #000000 !important; }
            .row-style:hover a{ color: #0081c5 !important; }
            .row-style:hover a:hover{ color:#004d77 !important; }
                                            ...
                                            <div class=""><%--col-xs-12 col-sm-12--%>
                                                <div class="row">
                                                    <asp:GridView ID="gvSummary" runat="server" AutoGenerateColumns="false" 
                                                        CssClass="listingArea center-table" DataKeyNames="BATCH ID" GridLines="None" >
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Batch ID" DataField="BATCH ID" ItemStyle-Width="7%" />
                                                            <asp:BoundField HeaderText="Batch Name" DataField="BATCH NAME" ItemStyle-Width="22%" />
                                                            <asp:BoundField HeaderText="Batch Type" DataField="BATCH TYPE NAME" ItemStyle-Width="11%" />
                                                            <asp:BoundField HeaderText="Scan Date" DataField="UPLOAD DATE" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" ItemStyle-Width="13%" />
                                                            <asp:BoundField HeaderText="Batch Total" DataField="BATCH TOTAL" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" FooterStyle-HorizontalAlign="Right" FooterStyle-CssClass="total" />
                                                            <asp:BoundField HeaderText="Processed" DataField="PROCESSED" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" FooterStyle-HorizontalAlign="Right" />
                                                            <asp:BoundField HeaderText="Deleted" DataField="DELETED" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" FooterStyle-HorizontalAlign="Right" />
                                                            <asp:BoundField HeaderText="In Value" DataField="IN VALUE" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" FooterStyle-HorizontalAlign="Right" />
                                            ...
                                            <div class=""><%--col-xs-12 col-sm-12--%>
                                                <div class="row">
                                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" 
                                                        CssClass="listingArea center-table" DataKeyNames="DOC ID" ShowFooter="false" GridLines="None">
                                                        <Columns>
                                                            <asp:BoundField HeaderText="Doc ID" DataField="DOC ID" ItemStyle-Width="8%" />
                                                            <asp:BoundField HeaderText="Doc Name" DataField="ORIGINAL NAME" ItemStyle-Width="34%" />
                                                            <asp:BoundField HeaderText="Status" DataField="Status" ItemStyle-Width="17%" />
                                                            <asp:BoundField HeaderText="Being Processed?" DataField="BEING EDITED" ItemStyle-Width="17%" />
                                                            <asp:BoundField HeaderText="Date Processed" DataField="FINAL ARCHIVING DATE" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" ItemStyle-Width="17%" />
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Width="7%">
                                                                <ItemTemplate>
