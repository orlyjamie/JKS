<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TiffViewerScanQC.aspx.cs" Inherits="NewLook.NewLook_ScanQC_TiffViewerScanQC" EnableEventValidation="false" %>
...
<body>
    ...
    <div style="z-index: 99; float: left; margin-top: 10px; width:100%; height:100%;">        
        <asp:TiffViewerControl ID="ctlTiff" runat="server" ImageQuality="100" ViewerHeight="600"  ThumbHeight="60" ThumbWidth="45"
            ViewerWidth="750"  FitType="FitWidth" CompressBurnedImage="true"
            ...
            CacheZoom="100" CachePageCount="1" CacheDelay="1" /><%--CacheZoom="100"--%><%--DefaultZoom="50"--%>
