<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TiffViewerScanQCNew.aspx.cs" Inherits="NewLook.NewLook_ScanQC_TiffViewerScanQCNew" EnableEventValidation="false"%>
<%@ Register Assembly="AnnotationTiffViewer" Namespace="TiffViewer" TagPrefix="asp" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Scan QC Tiff Viewer</title>
...
<body>
    ...
    <div style="z-index: 99; float: left; margin-top: 10px; width:100%; height:100%;">        
        <asp:TiffViewerControl ID="ctlTiff" runat="server" ImageQuality="100" ViewerHeight="600"  ThumbHeight="60" ThumbWidth="45"
              FitType="FitWidth" CompressBurnedImage="true"
            ShowThumbNails="true" AnnKeyboardEnabled="false" FastMode="true" AnnMouseCursor="../../images/pen.cur"
            AnnResizeColor="orange" AnnOnDeleteAnnotation="DeleteFn" AnnOnCreateAnnotation="CreateFn"
            AnnOnDoubleClickAnnotation="PropertiesFn" CacheClear="true" CacheForwarding="false"
            CacheZoom="200" CachePageCount="1" CacheDelay="1" /><%--CacheZoom="100"--%><%--DefaultZoom="50"--%><%--ViewerWidth="0"--%>
        <!-- The main tiff control end -->
        <input type="text" id="debug" style="overflow: scroll; height: 15px; width: 90%;display:none;"
            onclick="this.value = ''"  />    
        <b>
        <%--
            <%=ctlTiff.LicenseInfo %>
