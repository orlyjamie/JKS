...
namespace JKS
{
    public partial class JKS_ScanQC_ActionScanQCNew : System.Web.UI.Page
    {

        #region Variable declaration and initialization
        SqlConnection sqlConn = null;
        DataCenterActionScanQCNew DC = null;
       ...
       protected void btnAddModal_Click(object sender, EventArgs e)
        ...
        protected void btnReplaceModal_Click(object sender, EventArgs e)
        {
            ...
            foreach (var index in arrIndex)
            {
                ...
                newRow["NOMINALCODEID"] = (gvProduct.Rows[Convert.ToInt32(index)].FindControl("lblNominalCodeID") as Label).Text;
                newRow["BUSINESSUNITID"] = (gvProduct.Rows[Convert.ToInt32(index)].FindControl("lblBusinessUnitID") as Label).Text;
                newRow["PROJECTCODE"] = (gvProduct.Rows[Convert.ToInt32(index)].FindControl("lblProjectCode") as Label).Text; //Added by Mainak 2017-11-21
                newRow["PURORDERLINENO"] = (gvProduct.Rows[Convert.ToInt32(index)].FindControl("lblPurOrderLineNo") as Label).Text;//Added by Mainak 2018-05-31
                dt.Rows.Add(newRow);
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DC = new DataCenterActionScanQCNew(sqlConn);
        ...
        public static string[] ListSupplierNames(string input1, string input2)
        {
            ...
            SqlConnection sqlConn = new SqlConnection(CBSAppUtils.PrimaryConnectionString);
            DataCenterActionScanQCNew DC = new DataCenterActionScanQCNew(sqlConn);
    ...
    #region DataCenterActionScanQCNew Class for all data access functions
    class DataCenterActionScanQCNew
    {
        SqlConnection sqlConn = null;

        /// <summary>
        /// Constructor of DataCenterActionScanQCNew Class takes SqlConnection Object
        /// </summary>
        /// <param name="sqlConn">SqlConnection Object</param>
        public DataCenterActionScanQCNew(SqlConnection sqlConn)
        {
        ...
        public DataTable ReturnTopDataTable(int docID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnTopDataTable: " + ss);
                return dt;
            }
            finally
            {
        ...
        public void PopulateChildCompany(int ParentCompanyID, DropDownList ddlCompany)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.PopulateChildCompany: " + ss);
            }
            finally
            {
        ...
        public DataTable ReturnCurrencyDataTable()
        {
            ...
            catch (Exception ex)
            {
                DT = new DataTable();
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnCurrencyDataTable: " + ss);
            }
            finally
            {
                DA.Dispose();
        ...
        public void PopulateCurrency(DropDownList ddlCurrency)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.PopulateCurrency: " + ss);
            }
            finally
            {
        ...
        public void PopulateBatchType(int CompanyID, DropDownList ddlBatchType)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.PopulateBatchType: " + ss);
            }
            finally
            {
        ...
        public int ReturnClientCompanyID(int doc_id)
        {
            ...
            if (doc_id > 0)
            {
                ...
                {
                    string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                    HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnClientCompanyID: " + ss);
                }
                finally
                {
                    sqlConn.Close();
        ...
        public int ReturnBatchTypeID(int doc_id)
        {
            ...
            if (doc_id > 0)
            {
                ...
                {
                    string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                    HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnBatchTypeID: " + ss);
                }
                finally
                {
                    sqlConn.Close();
        ...
        public DataTable ReturnSupplierDataTable(string SupplierCompanyName, int BuyerCompanyID, string SupplierCodeAgainstBuyer = "", bool UseOrderBy = false)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.CheckValidSupplier: " + ss);
        ...
        public string ReturnValidSupplierCompanyBySupplierName(string SupplierName, int buyerID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnValidSupplierCompanyBySupplierName: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public DataTable ReturnSupplierDataTableByPONumber(string PONumber)
        {
            if (PONumber.Length > 0)
            {
                ...
                {
                    string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                    HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnSupplierDataTableByPONumber: " + ss);
                    return new DataTable();
                }
                finally
                {
        ...
        public int ReturnCurrencyIDByCode(string CurrencyCode)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnCurrencyIDByCode: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public string ReturnNewCurrencyCode(int SupplierCompanyID, int BuyerCompanyID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnNewCurrencyCode: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public string ReturnCurrencyCodeByID(int CurrencyID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnCurrencyCodeByID: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public bool UpdateBeingEdited(string status, int docID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.UpdateBeingEdited: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public string ReturnUserName(int UserID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnUserName: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public DataTable ReturnDOCIDs_DT(int batchid, bool checkBeingEditedNo)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnDOCIDs_DT: " + ss);
                return null;
            }
            finally
            {
        ...
        public DataTable ReturnValidity_DT(int BatchTypeID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnValidity_DT: " + ss);
                return DT;
            }
            finally
            {
        ...
        public bool MakeDocumentDeleted(int docID, int batchID)
        {
            ...
            catch (Exception ex)
            {
                st.Rollback();
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.MakeDocumentDeleted: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public bool UpdateFinalArchivingDate(int docID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.UpdateFinalArchivingDate: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public bool UpdateNumOfInvoicesArchivedByQC(int batchID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.UpdateNumOfInvoicesArchivedByQC: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public int ReturnSupplierID(string SupplierName, int buyerID, string CodeAgainstBuyer)
        {
            ...
            if (SupplierName.Length > 0)
            {
                ...
                {
                    string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                    HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnSupplierID: " + ss);
                }
                finally
                {
                    sqlDA.Dispose();
        ...
        public DataTable PathInformationTable(int comID, int docID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.PathInformationTable: " + ss);
        ...
        public string ReturnCompanyNameByBatchID(int BatchID)
        {
            ...
            if (BatchID > 0)
            {
                ...
                {
                    string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                    HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnCompanyNameByBatchID: " + ss);
                }
                finally
                {
                    sqlConn.Close();
        ...
        public DataTable ReturnAllDOCIDsDTInBatch(int batchid)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnAllDOCIDsDTInBatch: " + ss);
                return null;
            }
            finally
            {
        ...
        public DataTable ReturnBuyerProdCodeTableForPONumber(string PurOrderNo)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnBuyerProdCodeTableForPONumber: " + ss);
                return new DataTable();
            }
            finally
            {
        ...
        public string DocumentPosition(int BatchID, int DocID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.DocumentPosition: " + ss);
            }
            finally
            {
                DT.Dispose();
        ...
        public DataTable AvailableDocumentTable(int DocID)
        {
            ...
            catch (Exception ex)
            {
                DT = new DataTable();
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.DocumentState: " + ss);
            }
            finally
            {
                DT.Dispose();
        ...
        public bool SaveDocumentInformation(string DocType, string DocID, string CompanyID, string ImagePath, string ArchiveImagePath)
        {
            ...
            catch (Exception ex)
            {
                tf = false;
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.SaveDocumentInformation: " + ss);
            }
            finally
            {
                cmd.Dispose();
        ...
        public string ReturnCompanyNameByID(int CompanyID)
        {
            ...
            if (CompanyID > 0)
            {
                ...
                catch (Exception ex)
                {
                    CompanyName = "";
                    string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                    HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnCompanyNameByID: " + ss);
                }
                finally
                {
                    sqlDA.Dispose();
        ...
        public bool UpdateClerkIdEditing(int docID, int userID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.UpdateClertIdEditing: " + ss);
                return false;
            }
            finally
            {
        ...
        public DataTable ReturnDefaultsData(string BuyerCompanyID, string SupplierCompanyID)
        {
            ...
            {
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnDefaultsData: " + ss);
                return new DataTable();
            }
            finally
            {
        ...
        public DataTable ReturnNominalNameDataTable(int CompanyID, string UserString)
        {
            ...
            catch (Exception ex)
            {
                DT = new DataTable();
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnNominalNameDataTable: " + ss);
            }
            finally
            {
                DA.Dispose();
        ...
        public bool SaveSupplierDefaults(int BuyerCompanyID, int SupplierCompanyID, string SupplierCompanyName, int UserID, int CurrencyTypeID, string CurrencyCode, string VendorID, string VendorClass, bool Active, string Nominal1, string Nominal2, bool PreApprove, int ApprovalNeeded)
        {
            ...
            catch (Exception ex)
            {
                tf = false;
                string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.SaveSupplierDefaults: " + ss);
            }
            finally
            {
                sqlConn.Close();
        ...
        public DataTable ReturnAqillaSupplierDetails(int CompanyID)
        {
            ...
            if (CompanyID > 0)
            {
                ...
                catch (Exception ex)
                {
                    DT = new DataTable();
                    string ss = ex.Message + "<br />" + ex.Source + "<br />" + ex.StackTrace + "<br />" + ex.TargetSite + "<br />" + ex.InnerException;
                    HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.ReturnAqillaSupplierDetails: " + ss);
                }
                finally
                {
                    sqlDA.Dispose();
        ...
        public bool SAVE_AQILLA_SUPPLIERS(string SupplierXML, int BuyerCompanyID, int ModUserId)
        {
            ...
            catch (Exception ex)
            {
                ...
                HttpContext.Current.Response.Write("<br />Error in DataCenterActionScanQCNew.SAVE_AQILLA_SUPPLIERS: " + ss);

                ss = ss.Replace("<br />", "\n");
                CommonFunctions.CreateLog("Error in DataCenterActionScanQCNew.SAVE_AQILLA_SUPPLIERS: " + ss, "ProcessSupplierResponseLog.txt");
            }
            finally
            {
                cmd.Dispose();
