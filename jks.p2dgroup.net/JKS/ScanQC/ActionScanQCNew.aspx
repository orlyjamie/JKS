<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActionScanQCNew.aspx.cs"
    Inherits="JKS.JKS_ScanQC_ActionScanQCNew" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtSupplier.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        url: "ActionScanQCNew.aspx/ListSupplierNames",
                ...
                $(this).autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "ActionScanQCNew.aspx/ListPONumber",
            ...
            $("#lnkDefaults").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "ActionScanQCNew.aspx/DefaultsDataSet",
        ...
        function AjaxCall() {
            ...
            var $sel = null;
            for (i = 0; i < c; i++) {
                var po = $dr.eq(i).children().eq(1).find("input[type='text']").val();
                LinePOs += po;
                if (i < c - 1)
                    LinePOs += ",";
            }
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ActionScanQCNew.aspx/CheckValidPurchaseOrder",
        ...
        function isValidSupplier() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ActionScanQCNew.aspx/CheckValidSupplier",
        ...
        function SetCurrencyStatus() {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ActionScanQCNew.aspx/GetCurrencyStatus",
        ...
        function AttachDocument(type) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ActionScanQCNew.aspx/AttachDocument",
                data: '{"type":"' + type + '"}',
                dataType: "json",
                success: function (data) {
                    var x = data.d;
        ...
        function SaveDocumentData(type) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ActionScanQCNew.aspx/SaveDocumentData",
        ...
        function PopulateCurrencyForDefaults() {
            ...
            $.ajax({
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                url: 'ActionScanQCNew.aspx/CurrencyForDefaults',
                data: '',
                dataType: 'JSON',
        ...
        function UpdateAqillaSuppliers() {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                url: 'ActionScanQCNew.aspx/GetAqillaSupplierURL',
                data: '{"input1":"' + bcid + '"}',
                success: function (data) {
                    var val = data.d;
                    var arr = val.split('^');
                    ...
                    if (arr[0] == 'true') {
                        $aUAS.click(function () {
                            ...
                            $.ajax({
                                ...
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'JSON',
                                url: 'ActionScanQCNew.aspx/ProcessSupplierResponse',
    ...
    <style type="text/css">
        ...
        .tr-x .table-list .table-list-header th:nth-child(2), .tr-x .table-list .table-list-header th:first-child
        {
            width: 120px !important;
        }
        .tr-x .table-list .table-list-header th:nth-child(3)
        {
            width: 40% !important;
        }
        .container .content .table-menu .table-list td
        {
            width: inherit;
        }
    </style>
    ...
    <div class="container">
        ...
        <div class="content">
            <%--<table>
                <tr>
                    ...
                    <td style="width:45%">
                        <table>
                            <tr>
                                <td style="width:50%" class="tab selected" id="divHeader_clicker">Header</td>
                                <td style="width:50%" class="tab not_selected" id="divLineItems_clicker">Line Items</td>
                            </tr>
                        </table>
                    </td>
            ...
            <table class="table-menu" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="width: 20%; vertical-align: top" class="tdSpace">
                        <div class="scan-qc">
                            Scan QC
                        </div>
                        <div class="table_cont" style="color: #606060">
                            <%--change--%>
                            <table>
                                <tr>
                                    <td class="label">
                    ...
                    <td style="width: 50%; vertical-align: top" class="tdSpace">
                        <table class="table-menu" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <div class="shown" id="divHeader" style="color: #606060">
                            <%--change--%>
                            <table>
                                <tr>
                                    <td class="label">
                        ...
                        <div class="hidden tr-x" id="divLineItems" style="overflow: auto;">
                            <asp:GridView ID="gvLists" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="PO No.">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPONO" runat="server" Text='<%#Eval("PONO")%>' CssClass="PONO classPONumber">
                                            </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Product Code">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblProjectCode" runat="server" Text='<%# Eval("ProjectCode")%>' Visible="false"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Description" FooterText="Total">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDescription" runat="server" Text='<%#Eval("DESC")%>' TextMode="MultiLine"
                                                CssClass="DESC stretch"> <%-- cssclass "stretch" added by Mainak 2017-11-28--%>
                                            </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Value" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"
                                        FooterText="0.00">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="VAT" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"
                                        FooterText="0.00">
                                        <ItemTemplate>
                    ...
                    <td style="width: 30%; vertical-align: top" class="tdSpace">
                        <table class="table-menu" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="vertical-align: top;">
                                    <div class="scan-qc" style="padding-left: 15px;">
                                        Action</div>
                                </td>
                            </tr>
                        </table>
        ...
        <script type="text/javascript">
            ...
            $("#btnSave1").click(function () {
                ...
                $.ajax({
                    ...
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    url: 'ActionScanQCNew.aspx/SaveSupplierDefaults',
            ...
            $("#txtStockFBNominal").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        url: 'ActionScanQCNew.aspx/ListNominalName',
                                ...
                                <div class="row">
                                    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="false" CssClass="listingArea center-table"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Description" ItemStyle-Width="40%" FooterStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Value" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right"
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblNominalCodeID" runat="server" Text='<%# Bind("NominalCodeID")%>'
                                                        Visible="false" />
                                                    <asp:Label ID="lblBusinessUnitID" runat="server" Text='<%# Bind("BusinessUnitID")%>'
                                                        Visible="false"></asp:Label>
                                                    <asp:Label ID="lblProjectCode" runat="server" Text='<%# Eval("ProjectCode")%>' Visible="false"></asp:Label>
                                                    <%--Added by Mainak 2017-11-21--%>
                                                    <asp:Label ID="lblPurOrderLineNo" runat="server" Text='<%# Eval("PurOrderLineNo")%>'
                                        ...
                                        <%--ForeColor="Black" BackColor="#ffffff"--%>
                                    </asp:GridView>
                                </div>
                            </div>
                        </div>
