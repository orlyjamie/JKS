<%@ Control Language="c#" AutoEventWireup="false" CodeBehind="bannerNB.ascx.cs" Inherits="CBSolutions.ETH.Web.Utilities.bannerNB"
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr bordercolor="dimgray">
        ...
        <td align="right" class="Banner">
            <asp:HyperLink ID="hypLogOff" runat="server" ImageUrl="../images/btnLogOff.jpg" NavigateUrl="../newbuyerdefault.aspx">Log Off</asp:HyperLink>
        </td>
    </tr>
</table>
