<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Solutions_ISOCR.aspx.cs"
    Inherits="CBSolutions.ETH.Web.Solutions_ISOCR" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
    <title>Invoice processing|Invoice workflow|Invoice scanning|Invoice OCR - P2D Group
    </title>
    <meta charset="utf-8">
    ...
    <meta name="keyword" content="Invoice processing,Invoice workflow,Invoice scanning,Invoice OCR">
        ...
        <div class="container mainWrapper nopadding">
									...
									<ul class="nav navbar-nav">
										...
										<li class="dropdown active">
											...
											<ul class="dropdown-menu">
												<li>
													<a href="Solutions_Einvoicing.aspx" class="active" title="E-invoicing">E-invoicing</a>
												<li class="active">
													<a href="javascript:void(0)" title="Invoice Scanning & OCR">Invoice Scanning &amp; OCR</a>
												<li>
						...
						<div class="row">
							<div class="container">
								<div class="col-lg-12 ban_sub_wrapper">
									<img class="img_ban" src="assets/img/ban/ban_solutions_isocr.jpg" alt="Solutions::P2D Papper 2 Data">
									<h1>INVOICE SCANNING &amp; INTELLIGENT OCR</h1>
								</div>
							</div>
						</div>
					</section>
								...
								<div class="tabbable sidebar_pillsNav">
									<div id="side" class="nav-pillswrapper col-md-3 height_justified">
										<ul class="nav nav-pills nav-stacked">
											<li class="active">
												<a href="#tab_a" data-toggle="pill" class="tab-01" title="SUMMARY">SUMMARY<span class="li_arrow"></span></a>
											<li>
									...
									<div id="main" class="tab-content col-md-9 height_justified">
										<div class="tab-pane fade active in" id="tab_a">
											<div class="contentInner">
												<p>
													Whilst the <a href="http://www.p2dgroup.net/" target="_blank">P2D</a> Document Network incorporates the scanning module to process 
													paper documents alongside those sent electronically, clients can equally chose 
													a scanning solution in isolation.
												</p>
												<h3>KEY FEATURES</h3>
												<ul>
													<li>
													Latest Artificial Intelligence / Rules-based OCR technology
													<li>
													No onsite software, integration or implementation
													<li>
													No configuration or fine-tuning for supplier invoice formats
													<li>
														Detailed line item extraction out-of-the-box
														<br>
													(price, quantity, description, PO, net value)
													<li>
													Lookups for vendor and purchase order numbers
													<li>
													Web-deployed interface for reviewing data and images
													<li>
													Data checking and cleansing service
													<li>
													Option to outsource physical scanning
													<li>
													Supports multi-location scanning
													<li>
													Supports parent/child/divisional structures
													<li>
													Unlimited user licence as standard
													<li>
														Unlimited volume licence as standard</li>
												</ul>
											</div>
										</div>
            ...
            <div class="tab-content_02" style="display: none;">
                ...
                <section id="page">
							<div class="row">
								<div class="container-fluid">
									<div class="container bg_cover bg_row_solutions_2nd om-animation-enabled">
