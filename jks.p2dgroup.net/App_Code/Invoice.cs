...
{ 
    ...
    public class Invoice
    {
        ...
        public DataTable GetInvoiceDetails(int InvoiceID)
        {
            ...
            {
                sqlConn.Open();
                SqlDataAdapter da = new SqlDataAdapter("select * from invoicedetail where invoiceId='"+InvoiceID+"'", sqlConn);
                da.Fill(dt);
            }
		...
		*/
        ...
        public DataTable GetInvoiceLogStatusApproverWise(int iInvoiceID)
        {
            sqlConn = new SqlConnection(CBSAppUtils.PrimaryConnectionString);
            //			sqlConn.Open();
            sqlDA = new SqlDataAdapter("sp_GetInvoiceLogStatusApproverWise_Generic_GMGNew", sqlConn);
        ...
        public DataTable GetInvoiceLogStatusApproverWiseForSupplier(int iInvoiceID)
        {
            sqlConn = new SqlConnection(CBSAppUtils.PrimaryConnectionString);
            //			sqlConn.Open();
            sqlDA = new SqlDataAdapter("sp_CheckUserTypeBySessionUserIDForSupplier_Generic_GMG_New", sqlConn); 
            sqlDA.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetCrediNoteLogStatusApproverWise(int iInvoiceID)
        {
            ...
            sqlDA = new SqlDataAdapter("sp_GetInvoiceLogStatusApproverWiseNL_CN_New", sqlConn);
            sqlDA.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public int SaveInvoiceDatatoDataBase(int UserID, int InvoiceID, string strInvoiceNo, string strSupplierCompanyID, string strBuyerCompanyID,
            DateTime strInvoiceDate, DateTime strTaxPointDate, string strCurrency, string strSupplierAddress1,string strSupplierAddress2, string strSupplierAddress3,
            string strSupplierAddress4, string strSupplierAddress5,string strSupplierCountry, string strSupplierZIP, string strSellerVATNo, string strComments, string str22,
            decimal decNetTotal, decimal decVATAmt, decimal decTotalAmt, string strDeleteIDs, string strDepartmentID, string strBusinessUnitID)//Modified by Mainak 2018-03-19
        {
            ...
            try
            {
                sqlConn = new SqlConnection(CBSAppUtils.PrimaryConnectionString);
                sqlConn.Open();
                sqlCmd = new SqlCommand("usp_EditInvoiceTestBuyer_New", sqlConn);//Modified by Mainak 2018-03-19
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        #region Update Invoice/CreditNote After Reset from History Combind Window
        public void updateInvoiceAfterReset(int InvoiceID, string DocType)
        {
            string strExceptionMessage = "";
            try
            {
                sqlConn = new SqlConnection(CBSAppUtils.PrimaryConnectionString);
                sqlConn.Open();
                sqlCmd = new SqlCommand("usp_updateInvoiceAfterReset", sqlConn);//Added by Mainak 2017-12-19
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@InvoiceID", Convert.ToInt32(InvoiceID));
                sqlCmd.Parameters.Add("@DocType", DocType);
                sqlCmd.ExecuteNonQuery();
