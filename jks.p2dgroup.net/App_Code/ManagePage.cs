...
namespace JKS
{
    public class ManagePage
    {
        ...
        {
            return GetAll("*", condition, " P2D_ManageCMSPage");
        }
        /// <summary>
        ...
        public bool Save()
        {
            int iReturnValue = 0;
            bool bRetVal = true;
            //SqlCon=new SqlConnection(CBSAppUtils.PrimaryConnectionString);
            try
            {
                int Mode = (PageID == 0) ? 1 : 2;
                SqlCon.Open();
                SqlCmd = new SqlCommand("P2D_SP_InsertUpdateManageCMSPage", SqlCon);
                SqlCmd.CommandType = CommandType.StoredProcedure;
                SqlCmd.Parameters.Add("@Mode", Mode);
                SqlCmd.Parameters.Add("@PageID", PageID);
                SqlCmd.Parameters.Add("@PageTitle", PageTitle);
                SqlCmd.Parameters.Add("@NavigateUrl", NavigateUrl);
                SqlCmd.Parameters.Add("@IsParentPage", IsParentPage);
                SqlCmd.Parameters.Add("@ParentPageID", ParentPageID);

                SqlCmd.Parameters.Add("@PageOrder", PageOrder);
                SqlCmd.Parameters.Add("@ShowOnFooter", ShowOnFooter);
                SqlCmd.Parameters.Add("@ShowOnHeader", ShowOnHeader);
        ...
        public bool DeleteCMSPage(int iPageID, int ModifiedBy)
        {
            int iReturnValue = 0;
            bool bRetVal = true;
            ...
            SqlCmd = new SqlCommand("sp_P2D_DeleteManageCMSPageData", SqlCon);
            SqlCmd.CommandType = CommandType.StoredProcedure;

            SqlCmd.Parameters.Add("@PageID", iPageID);
