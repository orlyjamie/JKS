...
namespace JKS
{
    ...
    public class StockDal
    {
        ...
        public DataSet GetStockDocumentDetails(int InvoiceID, string Type)
        {
            ...
            //blocked by kuntalkarar on 5thJanuary2017
            //sqlDA = new SqlDataAdapter("GetStockDocumentDetailsETC", sqlConn);
            //Added by kuntalkarar on 5thJanuary2017
            sqlDA = new SqlDataAdapter("GetStockDocumentDetails_JKS", sqlConn);
        ...
        public DataSet GetGoodsRecdDetailByGoodsRecdID(int iGoodsRecd, string IPONO)
        {
            ...
            sqlDA = new SqlDataAdapter("GetGoodsRecdDetailByGoodsRecdIDETC_New_JKS", sqlConn); //Modified by Mainak 2018-05-25
